...
public final class DAArtGenerator extends AbstractArtSeleniumOverwriter {
    ...
    public void overwriteSeleniumTest() {
        ...
        try {
            ...
            outStream.newLine();
            outStream.write("<tr><td rowspan=\"1\" colspan=\"3\">DATest</td></tr>");
            outStream.newLine();
            outStream.write("</thead><tbody>");
            outStream.newLine();
            outStream.write("<tr>");
            outStream.newLine();
            outStream.write("	<td>open</td>");
            outStream.newLine();
            outStream.write("	<td>/newest/</td>");
            outStream.newLine();
            ...
            outStream.write("	<td>waitForVisible</td>");
            outStream.newLine();
            outStream.write("	<td>link=Anthro &gt; Digital Media &gt; Drawings &gt; Animals (158)</td>");
            outStream.newLine();
            outStream.write("	<td></td>");
            outStream.newLine();
            outStream.write("</tr>");
