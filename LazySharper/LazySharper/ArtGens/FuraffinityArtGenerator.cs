...
{
    internal class FuraffinityArtGenerator : ArtUploadTestGenerator
    {
        public override void GenerateSeleniumTest(ArtUploadModel model)
        {
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"Output\FA upload_ready_test.html"))
            {
