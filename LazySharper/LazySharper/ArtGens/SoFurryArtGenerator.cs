...
{
    internal class SoFurryArtGenerator : ArtUploadTestGenerator
    {
        public override void GenerateSeleniumTest(ArtUploadModel model)
        {
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"Output\SoFurry upload_ready_test.html"))
            {
                ...
                if(model.AgeRating == ContentRating.General||model.AgeRating == ContentRating.Teen)
                {
