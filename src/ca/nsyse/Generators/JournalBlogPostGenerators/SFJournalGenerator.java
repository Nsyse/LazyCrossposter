 ...
 */
public class SFJournalGenerator extends BlogPostGenerator {
    public SFJournalGenerator(String journalTitle, String journalDescription) {
        super("SoFurry", journalTitle, journalDescription);
    }
    ...
    public void overwriteSeleniumTest() {
        ...
        try {
            ...
            outStream.newLine();
            outStream.write("<title>bob</title>");
            outStream.newLine();
            ...
            outStream.newLine();
            outStream.write("<tr><td rowspan=\"1\" colspan=\"3\">bob</td></tr>");
            outStream.newLine();
            ...
            outStream.write("	<td>clickAndWait</td>");
            outStream.newLine();
            outStream.write("	<td>link=Journal</td>");
            outStream.newLine();
            outStream.write("	<td></td>");
            outStream.newLine();
            outStream.write("</tr>");
